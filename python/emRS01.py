...
Ian Cooper
 ...
 Documentation
    https://d-arora.github.io/Doing-Physics-With-Matlab/pyDocs/emRS01.pdf
"""
...
ax.plot(yP1*1e3,IY,'r',lw = 1, label = 'Y')
...
H = H - h    
ax.text(0,H,'  zP = %2.3e' % zP, fontsize = FS, color = [0,0,1])
# H = H - h    
