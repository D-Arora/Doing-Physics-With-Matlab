...
for n in range(nT-1):
    ...
    if n == 3000: S[n+1] = S[n+1] + 80
    if n == 4300: S[n+1] = S[n+1] + 50
    if n == 5400: S[n+1] = S[n+1] + 400
    if n == 5600: S[n+1] = S[n+1] + 100
    if n == 6900: S[n+1] = S[n+1] + 1200
    if n == 8100: S[n+1] = S[n+1] + 1400
    #     I[n+1] = I[n+1] + 1
...
#%% FIG 3:  Japan covid19
data = np.loadtxt('aaa.csv', delimiter=',')  
plt.rcParams['font.size'] = 12
plt.rcParams["figure.figsize"] = (5,3.5)
fig3, ax = plt.subplots(nrows=1, ncols=1)
ax.set_xlabel('days',fontname='Times New Roman')
ax.set_ylabel('I / 1000',fontname='Times New Roman')
ax.grid()
yP = data/1000    
ax.plot(yP,'b',lw = 2)
...
ax[1].set_xlabel('days',fontname='Times New Roman')
ax[1].set_ylabel('I / 1000',fontname='Times New Roman')
ax[1].grid()
yP = data/1000    
ax[1].plot(yP,'b',lw = 2)
ax[1].plot(t,I,'r',lw = 1.8)

ax[0].set_xlabel('days',fontname='Times New Roman')
ax[0].set_ylabel('S / S$_o$',fontname='Times New Roman')
ax[0].grid()
ax[0].plot(t,S/[S[0]],'k',lw = 2)
