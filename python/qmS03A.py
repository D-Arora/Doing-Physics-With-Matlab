...
Finite Difference Time Development Method: Animation
     ...
     Free particle: Electron motion in a semiconductor
...
Reference page for documentation and notes
    https://d-arora.github.io/Doing-Physics-With-Matlab/pyDocs/qmDS02.pdf
...
Nt = 6000            #  Number of time steps [30000]
L = 40e-9             #  Half-width of X domain [5e-9 nm] 
f = 100              # number of frames

U0 = 2.0              # Potential energy  [eV] U0 = 2 or no electric field U0 = 0 

C1 = 1/5             # Schrodinger equation constant

# INITIAL WAVE PACKET
s = 2e-9               # pulse width  [m]
wL = 2e-9            # nominal wavelength  [  1.5e-10 m]
xC = 10e-9              # pulse centre [m]
...
psiI = zeros([Nt,Nx])      # imaginary part wavefunction
...
for nt in range(0,Nt):
    ...
    Kavg[nt] = -hbar**2*simps(fn,x)/(2*me*e)
