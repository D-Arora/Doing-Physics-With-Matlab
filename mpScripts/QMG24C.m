...
% Documentation
% https://d-arora.github.io/Doing-Physics-With-Matlab/mpDocs/QMG2SEFDTD.htm
% IAN COOPER
% matlabvisualphysics@gmail.com
% 230530   Matlab R2021b
...
Nt = 30000;              %  Number of time steps [30000]
...
% PARAMETER LIST -----------------------------------------------------
 figure(2) 
   fs = 14;
   set(gcf,'units','normalized','position',[0.41 0.05 0.3 0.75]);
   axis([0 100 -10 100]);
