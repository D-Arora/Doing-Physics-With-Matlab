...
figure(4)   % Vm  vs  I
  ...
  plot(V,Iext.*ones(nT,1),'m','linewidth',1)
  Hplot = plot(V(end),Iext(end),'mo');
  set(Hplot,'markersize',8,'markerfacecolor','m');
  
  plot(V,IK,'k','linewidth',1)
  Hplot = plot(V(end),Inet(end),'ko');
  set(Hplot,'markersize',8,'markerfacecolor','k');
  
  plot(V,Inet,'b','linewidth',2)
  hold on
  Hplot = plot(V(end),Inet(end),'bo');
  set(Hplot,'markersize',8,'markerfacecolor','b');
  
  plot(V,INa,'r','linewidth',2) ;
  Hplot = plot(V(end),INa(end),'ro');
  set(Hplot,'markersize',8,'markerfacecolor','r');
  
  tm = 'I_{m} (b)    I_{Na} (r)    I_{ext} (m)    I_K (k)';
  title(tm,'fontweight','normal')
...
figure(5)   % t  vs  I
  ...
  plot(t,Iext.*ones(nT,1),'m','linewidth',1)
  plot(t,IK,'k','linewidth',1)
  plot(t,IL,'b','linewidth',2)
  plot(t,INa,'r','linewidth',2) ;
  
  
  Hplot = plot(t(end),Iext(end),'mo');
  set(Hplot,'markersize',8,'markerfacecolor','m');
  
  Hplot = plot(t(end),Inet(end),'ko');
  set(Hplot,'markersize',8,'markerfacecolor','k');
  
  Hplot = plot(t(end),IL(end),'bo');
  set(Hplot,'markersize',8,'markerfacecolor','b');
  
  Hplot = plot(t(end),INa(end),'ro');
  set(Hplot,'markersize',8,'markerfacecolor','r');
