...
% INPUTS
% ========================================================================
Nx = 449;         % [1001]   must be an odd number - number of grid points
...
U0 = -50;   U1 = -50; U2 = 5;   % max value for PE / limits for PE vs x plot
UyTick = [-50 10];
%UyTick = [0 100];

NxC = round(Nx/2);        % centre postion for Simpson's rule Prob1 and Prob2     

L = pot(end,1);  %4e-9;                 % [ 4e-9]   length
...
% (4) hill U0 > 0  or well U) < 0   (5)  parabolic well  (6)
    flagU = 6;
