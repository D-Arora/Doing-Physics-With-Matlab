...
% axis of rotation
    ...
    col = 'r';
    plot(xP,yP,col,'lineWidth',2);
    text(0.5,-0.5,'axis of rotation','Color','r');
...
% region - reflection
    ...
    xP = x; yP = -y;
    h_area = area(xP,yP);
    set(h_area,'FaceColor',[1 0.8 0.8]);
...
axis off
set(gca,'Xlim',[0 4.2]);
set(gca,'Ylim',[-4.2 4.2]);
set(gca,'Zlim',[-4.2 4.2]);
...
% 
% %%
figure(7)   % animation of the rotation ---------------------------------
set(gcf,'units','normalized','position',[0.6 0.4 0.22 0.22]);

% OUTTER SURFACE
% X Y Z axes
   col = 'k';  LW = 1;
   plot3([-6 6], [0 0], [0 0],col,'linewidth',LW);
   hold on
   plot3([0 0],[-1 5],[0 0],'r','linewidth',LW+2);
   plot3([0 0], [0 0], [-6 6],col,'linewidth',LW);
   xlabel('x'); ylabel('y'); zlabel('z') 
   hold on
   grid on
