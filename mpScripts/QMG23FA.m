...
% ANHARMONIC OSCILLATOR: MORSE POTENTIAL  HCl molecule
% n quantum number 1,2,3, ...
% n-1  vibrational qunatum number 0,1,2, ...

% https://faculty.csbsju.edu/frioux/q-jump/HCl-VibRot.pdf
...
% INPUTS  ================================================================
   ...
   xMin = 0; xMax = 0.4;    % x range [nm]
   x0 = 0.127;              % Equilibrium bond length HCl  [nm]
   U0 = -4.57;              % Well depth [eV]
   k = 480;                 % HCL molecule: spring constant
   M = 13;                   % Stationary state M 
  
% CONSTANTS ========================================================
  h    = 6.62607015e-34;  % Planck's constant
  hbar = 1.05457182e-34;
  mu    = 1.62747e-27;    % reduced mass HCl molecule
  e    = 1.60217663e-19;  % electron charge
  c    = 2.99792458e8;      % speed of light
  Ls = 1e-9; Es = e;      % scaling factors: position [nm]  energy [eV]
  Cs = -hbar^2/(2*mu*Ls^2*Es);  % SE constant

% SETUP  ===========================================================
  x = linspace(xMin,xMax, NX);
  S = sqrt(2*abs(U0)*Es/k)/Ls;    % Width of potential well parameter
...
% Theoretical energy level for a paraboic well
  ...
  w0 = sqrt(k/mu);              % fundamental vibraton frequency             
  ET = (cn+0.5).*(hbar*w0/e);   % total energy  [eV]
