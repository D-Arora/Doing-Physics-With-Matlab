...
disp('  ');
disp(' 10: y = user defined function')          % user defined
disp('  ');
eqType = input('Enter a number from 1 to 10:      ');
...
nIterations = 8000;                     % number of iterations for minimizing chi2
...
switch eqType
   ...
   a(3,1) = x(1) - a(4,1) * log((y(1)-a(1,1))/a(2,1));
...
if eqType == 10, disp('10: user defined'); end;   
...
set(gcf,'Position',[0.1 0.2 0.4 0.4])
