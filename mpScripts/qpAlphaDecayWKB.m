...
% WKB approximation to solve the Schrodinger Equation with the nuclear potential:
...
hold on;
plot(x,Uo,'linewidth',2);
hold on;
plot(x,U,'linewidth',2); 
line([0,L],[E,E]);  %Plot line of alpha particles' energy
legend('Saxon-Woods','Coulomb ','Centrifugal','U_eff','E','location','southeast');
hold on;

xlim([0.1 30]);
ylim([-50 30]);
set(gca,'fontsize',12)
xlabel('radial position  r  [fm]');
ylabel('energy  [MeV]')
grid on
