...
% Country Variables p P q Q  ===========================================   
     p1 = ones(num,1).*a; q1 = p1;     % a
     p2 = ones(num,1).*b; q2 = p2;     % b
     p3 = zeros(num,1)  ; q3 = p3;     % M  increment dS/dt
     p4 = zeros(num,1)  ; q4 = p4;     % E  increment DI/dt
...
function [P1,P2,P3,P4] = CV(flagC,n,Q1,Q2,Q3,Q4)
global a b
...
case 4   % INDIA ************************************************** 
      ...
      if n > 800  && n < 2001; P3 = 3.2e-4; end 
      if n > 2000 && n < 3201; P3 = 2.0e-4; end
      if n > 3200 && n < 3801; P3 = 11.0e-4; end    
 
      if n > 1800 && n < 3001; P4 = 3.2e-5; end 
