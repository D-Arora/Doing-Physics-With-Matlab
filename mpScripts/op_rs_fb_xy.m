...
% INPUTS 
% =======================================================================
    n1 = 153;             % Aperture: grid points for inner ring
    n2 = 253;            % Aperture: grid points for outer ring
    nR = 255;             % Aperture: number of rings    must be ODD
    nP = 255;             % Screen (Observation plane XY): must be odd
...
fprintf('   percentage radiant flux enclosed within 1st min = %3.1f  % \n',100*WE_Psum(min(indexMin))/WE_Q);
disp('   ');
