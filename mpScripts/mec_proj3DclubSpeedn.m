...
% Club head speed  / launch speed
  vC = linspace(100,210,NS);
...
figure(1)
  ...
  subplot(2,1,1)
  plot(vC,X,'color',col,'linewidth',2)
  hold on; grid on
  txtX = 'club head speed v_C [ m/s ]';
  txtY = 'Range  [ m ]';
  txtT = '  ';
  plotSetup(txtX,txtY,txtT)
  hold on
  subplot(2,1,2)
  plot(vC,H,'color',col,'linewidth',2)
  hold on; grid on
