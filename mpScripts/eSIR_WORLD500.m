...
for n = 1 : num-1
   ...
   R(n+1) = R(n) + h*(kR1+2*kR2+2*kR3+kR4)/6;
    ...
    if n > 1400  && n < 2601;  S(n+1) = 0.2; end
    if n > 2600  && n < 4001;  S(n+1) = 0.15; end
    if n > 4000  && n < 5001;  S(n+1) = 0.12; end
    if n > 5000  && n < 6001;  S(n+1) = 0.28; end
    if n > 6000  && n < 7001;  S(n+1) = 0.70; end 
%  if n > 2999 && n < 4000; S(n+1) = 0; end
    if n > 7000; S(n+1) = 1; end
