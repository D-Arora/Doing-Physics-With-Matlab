...
%  if n == 2200; S(n) = 0.8; end  
%  if n == 2233; S(n) = 0.8; end  
%  if n == 2300; S(n) = 0.8; end  
...
subplot(2,2,1)   
   ...
   title(cn)
   hold on
   plot(t(1:4880),Itot(1:4880),'r','linewidth',1)
   xlim([0 tMax])
 ...
 subplot(2,2,2) 
   ...
   hold on
   plot(t(1:4880),I(1:4880),'r','linewidth',2)
   set(gca,'fontsize',FS)
   set(gca,'fontName','times')
   yMax = ylim;
   z = yMax(2);
  ...
  subplot(2,2,3)   
   ...
   ylabel('Recoveries')
   hold on
   plot(t(1:4880),C(1:4880),'r','linewidth',2)
   set(gca,'fontsize',FS)
   set(gca,'fontName','times')
   yMax = ylim;
   z = yMax(2);
  ...
  subplot(2,2,4)   
   ...
   ylabel('Deaths/1000')
   hold on
   plot(t(1:4880),D(1:4880)/1000,'r','linewidth',2)
   set(gca,'fontsize',FS)
   set(gca,'fontName','times')
   yMax = ylim;
   z = yMax(2);
