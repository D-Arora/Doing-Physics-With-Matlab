...
% INPUTS 
% =======================================================================
    n1 = 53;             % Aperture: grid points for inner ring
    n2 = 53;            % Aperture: grid points for outer ring
    nR = 55;             % Aperture: number of rings    must be ODD
    nP = 55;             % Screen (Observation plane XY): must be odd
