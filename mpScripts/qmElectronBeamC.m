...
figure(7)
   ...
   hh = hh+dh; 
   txt = sprintf('\\lambda_1 = %3.4f nm      \\lambda_{2} = %3.4f nm      \\lambda_2 / \\lambda_1 = %3.2f', ...
       wL1/X,wL2/X, wL2/wL1);
   text(0,hh,txt,'fontsize',12)
  
   hh = hh+dh; 
   txt = sprintf('\\lambda_{N1} = %3.4f nm     \\lambda_{N2} = %3.4f nm    \\lambda_2 / \\lambda_1 = %3.2f', ... 
       wL1_N/X,wL2_N/X, wL2_N/wL1_N);
   text(0,hh,txt,'fontsize',12)
   ...
   hh = hh+dh;
   txt = sprintf('Electron density  n_1 = %3.2e  m^{-1}     n_2 = %3.2e  m^{-1}', n(1), n(2));
   text(0,hh,txt,'fontsize',12)
   
   hh = hh+dh;
   txt = sprintf('n_2 / n_1 = %3.2f', n(2)/n(1));
   text(29,hh,txt,'fontsize',12)
