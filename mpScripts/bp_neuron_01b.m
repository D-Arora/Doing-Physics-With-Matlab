...
Jext_max = 0.07e-4;   % max current density for ext stimulus (A.cm^-2)
                     % default 1e-4
...
tm1 = ' I_0  =  '; tm2 = num2str(1000*Jext_max,4); tm3 ='  mA.cm^{-2}';
title_m = [tm1 tm2 tm3]; 
...
title_x = 'time  t   (ms)';   title_y = 'conductance  g  ( m\omega.cm^{-2})';
