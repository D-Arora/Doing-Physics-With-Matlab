...
% Meal #1
 ...
 % Meal #2
    G0(2) = 200;
    tM(2) = 6;      % time of meal [hours]
    tHG(2) = 30;     % half-life  [min]
...
% Meal #3
    G0(3) = 300;
    tM(3) = 13;      % time of meal [hours]
    tHG(3) = 30;     % half-life  [min]
...
% Meal #4
    G0(4) = 50;
    tM(4) = 4;       % time of meal [hours]
    tHG(4) = 15;     % half-life  [min]
 ...
 % Meal #5
    G0(5) = 50;
    tM(5) = 11;       % time of meal [hours]
    tHG(5) = 15;     % half-life  [min]
 ...
 % Meal #6
    G0(6) = 50;
    tM(6) = 17;       % time of meal [hours]
    tHG(6) = 15;     % half-life  [min]
