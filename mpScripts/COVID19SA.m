  ...
  case 1
     ...
     % SURGE FACTORS
       ...
       for n = 1:num-1
          ...
          if t(n) > 80;  s(n) = 6.00; end
          if t(n) > 83;  s(n) = 6.50; end
          if t(n) > 86;  s(n) = 7.50; end
          if t(n) > 95; s(n) = 0.00; end  
       end    
      ...
      % SURGE FACTORS
       s = zeros(num,1);
         for n = 1:num-1
            ...
            if t(n) > 69; s(n) = 1.50; end 
            if t(n) > 75; s(n) = 2.50; end
            if t(n) > 78; s(n) = 3.50; end
