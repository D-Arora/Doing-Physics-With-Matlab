...
function FI = IDOT(t,E,I,R)
  global a b
    FI =  a*E*I - b*I; %b*(E-1)*I ;%a*E*I - b*I;
end
...
case 1   % WORLD **************************************************
       if n > 700  && n < 1301; z = 1.5; end
       if n > 1300 && n < 1901; z = 1.2; end
       if n > 1900 && n < 3500; z = 1.25; end
%      if n > 3000 && n < 3021; z = 1.3; end

       if n > 1000 && n < 3000; w = 0.00002; end
     %     
case 2  % U.S.A.  *********************************************** 
      if n > 700   && n < 1251;   z = 2.5; end
      if n > 1500  && n < 2200;   z = 0.6; end
 %     if n > 2000  && n < 2201;   z = 0.2; end
...
case 5  % ITALY  *********************************************** 
       ...
       if n > 1450  && n < 2351;  z = 4.2; end
       if n > 2350 && n < 2701;   z = 1.2; end
%       if n > 2700 && n < 2901;  z = 1.5; end
%       if n > 2400 ;  z = 0.8; end


case 6  % GERMANY  *********************************************** 
      if n > 1600  && n < 1851;   z = 5; end
...
case 11  % JAPAN  *****************************************************
       if n > 0     && n < 51;     z = 12; end
       if n > 900   && n < 1281;   z = 2.1; end
       if n > 1280  && n < 2001;   z = 0.8; end
       if n > 2000  && n < 2301;   z = 1.3; end
       if n > 2300  && n < 2401;   z = 1.9; end
       if n > 2400  && n < 2801;   z = 1.4; end
       if n > 2801  && n < 2951;   z = 2.0; end
end     
