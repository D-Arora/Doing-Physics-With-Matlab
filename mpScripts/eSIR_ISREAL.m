...
for n = 1 : num-1
     ...
     if n > 1100 && n < 1551;  S(n) = 2.3; end 
     if n > 1550 &&  n < 1701; S(n) = 1.5; end 
     if n > 1950 &&  n < 2251; S(n) = 2.3; end 
     if n > 2800 &&  n < 3351; S(n) = 2.0; end
%     if n > 2800 &&  n < 3071; S(n) 
   
    if n > 2301; b = 0.08; end
    if n > 3350; S(n) = 1; end
