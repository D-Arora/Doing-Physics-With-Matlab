...
for n = 1 : num-1
  ...
  if n == 935; S(n) = 1.2; end
  if n == 2200; S(n) = 0.200; end
%   if n == 2500; S(n) = 0.4; end
%   if n == 2600; S(n) = 0.65; end
%   if n == 2700; S(n) = 0.75; end
%   if n == 2800; S(n) = 0.75; end 
%   if n == 2900; S(n) = 0.75; end 
%   if n == 3000; S(n) = 0.75; end 
