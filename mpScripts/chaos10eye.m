...
% Reitna model: C-cells / H-cells negative feedback interaction
...
% D.E. coefficients  K matrix  [2 1 0; 2 -1 0]   comment / uncomment
% tauC = 0.025; tauH = 0.08; k = 4; L = 10;
 tauC = 0.1; tauH = 0.5; k = 0.5; L = 3;

% Initial conditions t = 0: x1(1)  [C = 0]
   x1I = 0;
   
% Initial conditions: t =0: x2(1)  [H = 0]]
   x2I = 0;  

% Time domain: time interval tMax [0.5] / number of time steps nT [2000]
   tMax = 2;
   nT = 2000;
...
% K matrix
  k11 = -1/tauC; k12 = -k/tauC; k13 = L/tauC;
  k21 = 1/tauH; k22 = -1/tauH; k23 = 0;
  K = [k11 k12;k21 k22];
...
% Phase space state variables: Solutions for "z values" 
...
% Graph setup   
   ...
   box on
   tm1 = 'b_{11} = ';
   tm2 = num2str(b(1,1),'%3.1f ');
   tm3 = '   b_{22} = ';
   tm4 = num2str(b(2,2),'%3.1f');
   tm = [tm1 tm2 tm3 tm4];
