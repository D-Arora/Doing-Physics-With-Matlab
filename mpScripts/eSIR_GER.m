...
for n = 1 : num-1
   ...
   if n > 1500 && n < 2101; S(n) = 0.25; end
   
   if n > 2200 && n < 2751; S(n) = 0.44; end
   
   if n > 2700 && n < 2941; S(n) = 0.32; end
   
   if n > 2940 && n < 3171; S(n) = 0.36; end
   
   if n > 3171; S(n) = 0.22; end
   ...
   Idot(n+1) = a*S(n+1)*I(n+1) - b*I(n+1);
...
subplot(5,1,1)   
   ...
   xlabel('Days elapsed')
   ylabel('dI/dt')
   plot(t,gradient(I,h),'m')
   hold on
   plot(t,Idot,'r','linewidth',2)
   title(cn)
   text(-30,-5e4,'15 Feb 2020')
