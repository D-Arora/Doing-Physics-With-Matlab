...
% Special Thanks to Ian Cooper for Inspiring me
...
load ('India_covid19_data.mat')
% save India_covid19_data.mat India_covid19
...
% Col 9: USA     Deaths
% Col 10: IND     Total infected cases
% Col 11: IND     Currently infected cases
% Col 12: IND     Deaths
...
%   I(27) = Id(27)
 ...
 % Scale populations
  ...
  % Model: total population has been infected;
  Itot = I+R+D;
  ITmax = max(Itot);
