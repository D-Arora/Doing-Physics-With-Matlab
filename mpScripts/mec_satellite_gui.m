...
if (isempty(box4)); box4 = iv(4);   
else box4 = str2num(box4); end  

box5 = get(ucH.box5,'String');
if (isempty(box5)); box5 = iv(5);   
else box5 = str2num(box5); end  

box6 = get(ucH.box6,'String');
if (isempty(box6)); box6 = iv(6);   
else box6 = str2num(box6); end  
