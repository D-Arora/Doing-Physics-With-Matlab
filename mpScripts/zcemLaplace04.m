...
% Number of XY grid points ( ODD integer )
     Nx = 101;  Ny = 101;  
% Length of outer square L1 and length of inner square
     L1 = 10;
     L2 =  2;
% boundary values for the potential outer V1 and inner V2
    V1 = 10;
    V2 = 5; 
...
% charge Q / capacitance per unit length / 
   Q2 =  4*eps0*simpson1d(Ey2',minX1,maxX1);
   Q1 = -4*eps0*simpson1d(Ey1',minX2,maxX2);
