...
for nt = 1: Nt
   ...
   if f_gif > 0   
    ...
    if nt == 1
        imwrite(imind,cm,ag_name,'gif','DelayTime',0,'loopcount',inf);
    else
        imwrite(imind,cm,ag_name,'gif','DelayTime',0,'writemode','append');
    end
   end
end
   
     
% Save or not save anumated gif file         
%if f_gif > 0
