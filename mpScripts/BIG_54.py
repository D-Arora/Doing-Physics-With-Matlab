...
G0 = np.array([200,0,0,0,0,0,0,0])  

# >>> Half-life [min] h > 0   
h  = np.array([10,20,1,1,1,1,1,1,])  
tH = h/(60*24)
# >>> Time of meal  [hours]    
...
# G I values after 1,2,3,4 h after meal
Gt = np.zeros(4)
It = np.zeros(4)
for c in range(4):
  s = int((c+3)*(N-1)/12)
...
print('   ')
print('G at 1,2,3,4 h after meal')
print(Gt)
print('I at 1,2,3,4 h after meal')
print(It)
print('  ')
print('MEAL')
