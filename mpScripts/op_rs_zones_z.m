...
n1 = 211;             % Aperture: grid points for inner ring
n2 = 911;             % Aperture: grid points for outer ring
nR = 1000;             % Aperture: number of rings
nP = 5309;             % Screen (Observation plane XY): must be odd
wL = 632.8e-9;        % wavelength [m]
uQmax = 1e-3;         % Aperture: incident energy density  [W.m^-2]
xP = 0;         % Aperture to Screen distance  [m]
