...
case 5  % ITALY  *********************************************** 
      ...
      if n > 200 && n < 800, ZZ(n) = 0.001; pA = a; end
      if n > 1200 && n < 1801, ZZ(n) = 0.004; end
      if n > 1800 && n < 2001, ZZ(n) = 0.02; end
      if n > 2000 && n < 2101, ZZ(n) = 0.06; pB = 1.0*b; end
      if n > 2100 && n < 2351, ZZ(n) = 0.13; pA = 1.0*a; pB = 1.0*b; end
      if n > 2350 && n < 3301; ZZ(n) = 0.04; end
...
case 11  % JAPAN  *****************************************************
%          if n > 800  && n < 1301;   pS = 0.28; end
%          if n > 1600 && n < 1901;   pS = 0.17; end
%          if n > 2000 && n < 2201;   pS = 0.22; end
%          if n > 2200 && n < 2351;   pS = 0.33; end
%          if n > 2350 && n < 2701;   pS = 0.25; end
%          if n > 2700 && n < 2751;   pS = 0.30; end
%          if n > 2750 && n < 2931;   pS = 0.43; end
%          if n > 2930; pS = 0.20; end
%          
%          if n > 2000; pA = 0.5; end
%          if n > 2000; pB = 0.01; end

          if n < 200, ZZ(n) = 0.003; end
          if n > 1000 && n < 1401, ZZ(n) = 0.01; end
          if n > 1400 && n < 2001, ZZ(n) = 0.004; end
          if n > 2000 && n < 2201, ZZ(n) = 0.006; end
          if n > 2200 && n < 2501, ZZ(n) = 0.015; end
          if n > 2500 && n < 2700, ZZ(n) = 0.02; end
          if n > 2700 && n < 2801, ZZ(n) = 0.04; end
          if n > 2800 && n < 2950, ZZ(n) = 0.06; end
          if n > 2950 && n < 3101, ZZ(n) = 0.01; end
          if n > 3100 && n < 3600, ZZ(n) = 0.005; end
